			...
			switch (getOrSet)
			{
				case GetSet.Get:
					switch (property)
					{
						...
						#if UNITY_6000
							iob.Value = target.compositeOperation != CompositeOperation.None;
						#else
				...
				case GetSet.Set:
					switch (property)
					{
						...
						case Property.UsedByComposite:
							...
							if (iob.Value)
							{
								target.compositeOperation = CompositeOperation.Intersect;
							}
							else
							{
								target.compositeOperation = CompositeOperation.None;
							}
						#else
