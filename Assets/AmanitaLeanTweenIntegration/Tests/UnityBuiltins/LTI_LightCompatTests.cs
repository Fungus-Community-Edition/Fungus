...
{
    public class LTI_LightCompatTests : LeanTweenAdapterTests
    {
        private static readonly LeanTweenCase<Light, float> IntensityCase = new LeanTweenCase<Light, float>
        {
        ...
        private static readonly LeanTweenCase<Light, Color> ColorCase = new LeanTweenCase<Light, Color>
        {
        ...
        private static readonly LeanTweenCase<Light, float> RangeCase = new LeanTweenCase<Light, float>
        {
        ...
        [UnityTest]
        public IEnumerator Tween_Completes_Float([ValueSource(nameof(FloatCases))] LeanTweenCase<Light, float> tc)
        {
        ...
        [UnityTest]
        public IEnumerator Tween_Completes_Color([ValueSource(nameof(ColorCases))] LeanTweenCase<Light, Color> tc)
        {
            var comp = tc.CreateComponent(_testGo);
