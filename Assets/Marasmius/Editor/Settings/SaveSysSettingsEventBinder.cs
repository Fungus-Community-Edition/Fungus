...
namespace AtMycelia.SaveSys.EditorUtils
{
    ...
    public sealed class SaveSysSettingsEventBinder
    {
        ...
        public void OnStorageSettingsChanged(ChangeEvent<Object> evt)
        {
            _sysSettings.StorageSettings = evt.newValue as SaveStorageSettings;
            _synchronizer.MakeChangesStick();
        }

        public void OnReaderDropdownChoiceChanged(ChangeEvent<string> evt)
        {
        ...
        public void OnWriterDropdownChoiceChanged(ChangeEvent<string> evt)
        {
