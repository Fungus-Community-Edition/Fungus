...
namespace Amanita.VScripting.EditorUtils.FcWindow
{
    ...
    public sealed class ConnectionGathererUitk : IConnectionGatherer
    {
        ...
        public ConnectionGathererUitk(IBlockRectProvider rectProvider)
        {
        ...
        private static void ApplyMeasureStyles(UitkButton button)
        {
            ...
            button.AddToClassList(DefaultBlockDrawerUitk.BaseClass);
            button.AddToClassList(DefaultBlockDrawerUitk.SelectedClass);
            button.EnableInClassList(DefaultBlockDrawerUitk.SelectedClass, false);
        }
