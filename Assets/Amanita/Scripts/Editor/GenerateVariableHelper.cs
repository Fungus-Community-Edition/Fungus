...
namespace Amanita.EditorUtils
{
	...
	public class VariableScriptGenerator
	{
		...
		private const string EditorDataDrawerScriptTemplate = @"
...
{{
	...
	{{ }}
		...
		private const string VariableAndDataScriptTemplate = @"
...
{{
	...
	{{
		...
		private const string VariableOnlyScriptTemplate = @"
...
{{
	...
	{{ }}
		...
		private const string DataBasedPropertyScriptTemplate = @"
...
{5}
		...
		//6 variableProperty Type of
		//7 null check summary
		private const string VariableOnlyPropertyScriptTemplate = @"
