...
namespace AtMycelia.Amanita.DialogueSys.VScripting
{
    ...
    public class Conversation : Command
    {
        ...
        protected virtual IEnumerator DoConversation()
        {
            ...
            // TODO: reduce coupling between the Conversation Command and the ConversationManager by
            // using events or a shared data structure for the conversation settings instead of setting
            // them directly on the manager.
