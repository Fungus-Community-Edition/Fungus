    ...
    public class FadeToView : Command 
    {
        ...
        protected virtual void ValidateTweeners()
        {
            ...
            void ApplyDefaultsAsInits()
            {
                ...
                {
                    orthoSizeTweener = DefaultTweener;
                }

                if (posTweener == null)
                {
                    posTweener = DefaultTweener;
                }

                if (rotTweener == null)
                {
                    rotTweener = DefaultTweener;
                    return;
                }
            }
