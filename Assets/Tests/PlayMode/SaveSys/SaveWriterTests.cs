...
namespace SaveSystemTests
{
    public class SaveWriterTests : CommonTestFunctionality
    {
        ...
        public async Task VerifyFileContent_NONEncrypted_AfterWrite()
        {
            ...
            string expectedAll = $"{expectedMetaJson}{SaveDiskAccessor.ReadWriteDelimiters}{expectedMainJson}{SaveDiskAccessor.CompletionMarker}";
        ...
        public async Task VerifyFileContent_Encrypted_AfterWrite()
        {
            ...
            string expectedMainJson = serializerForTest.ToJson(args.MainState, true);
            string expectedPlain = $"{expectedMetaJson}{SaveDiskAccessor.ReadWriteDelimiters}{expectedMainJson}{SaveDiskAccessor.CompletionMarker}";
