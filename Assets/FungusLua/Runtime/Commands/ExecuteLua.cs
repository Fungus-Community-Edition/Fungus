...
namespace AtMycelia.Amanita.Lua.VScripting
{
    ...
    public class ExecuteLua : Command 
    {
        ...
        protected virtual void InitExecuteLua()
        {
            ...
            if (luaEnvironment == null && flowchartLuaSettings != null)
            {
                luaEnvironment = flowchartLuaSettings.LuaEnvironment;
            }
            ...
            string bindingName = flowchartLuaSettings != null ? flowchartLuaSettings.LuaBindingName : "";
            if (!string.IsNullOrEmpty(bindingName) && flowchart != null)
            {
                Table globals = luaEnvironment.Interpreter.Globals;
                if (globals != null)
                {
                    globals[bindingName] = flowchart;
                }
            }
