...
namespace Amanita.VScripting.EditorUtils
{
    ...
    /// </summary>
    public sealed class ZoomHandlerUitk : IFlowchartWindowModule,
        ...
        IFlowchartChangeResponder
    {
        ...
        public ZoomHandlerUitk(FlowchartContext context, float minZoomLevel = DefaultZoom, float maxZoomLevel = DefaultZoom)
        {
